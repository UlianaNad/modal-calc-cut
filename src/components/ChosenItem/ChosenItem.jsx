...
//Розмітка лівої сторони

// const refs = {
//     chosenItemEl: document.querySelector('.chosen-item'),
//     formEl: document.querySelector('.item-sizes-form'),
//     widthEl: document.querySelector(".width"),
//     heightEl: document.querySelector(".height"),
//     cuttingPiecesEl: document.querySelector(".cut_piece"),
// }
